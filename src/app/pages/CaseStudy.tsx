...
import { ClarityChecker } from "../components/ClarityChecker";
import { ContentDecisionTree } from "../components/ContentDecisionTree";
...
export default function CaseStudy() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Image */}
      {project.heroImage && project.id !== "ai-experimentation" && (
        ...
        {project.solution.features && (
          <div className="mt-16 space-y-20">
            {project.solution.features.map((feature, i) => {
              // Special handling for AI Experimentation interactive tools
              if (project.id === "ai-experimentation") {
                return (
                  <motion.div
                    key={feature.title}
                    initial={{ opacity: 0, y: 40 }}
                  ...
                  >
                    <div>
                      ...
                      <p className="text-gray-700 text-xl leading-relaxed max-w-4xl mb-8 whitespace-pre-line">{feature.description}</p>
                    </div>
                    <div className="p-8 bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl border-2 border-purple-200">
                      {feature.title === "Content Clarity Checker" && <ClarityChecker />}
                      {feature.title === "Content Decision Tree" && <ContentDecisionTree />}
                    </div>
                  </motion.div>
                );
              }
